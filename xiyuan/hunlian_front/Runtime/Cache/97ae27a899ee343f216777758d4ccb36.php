    ...
    <div class="fulli_page_about">
        ...
        <div class="row-fluid bg_about">
			 <div class="span12" style="height:60px;"></div>
               ...
               <div class="container page_bg" >手机号 ：18210354073 &nbsp; <div class="btn-group"><a href="" class="btn btn-success">修改手机认证</a> </div></div>
               <div class="container page_bg">邮箱 ：18210354073 &nbsp; <div class="btn-group"><a href="" class="btn btn-success">修改邮箱认证</a></div></div>
               <div class="container page_bg">微博：18210354073 &nbsp; <div class="btn-group"><a href="" class="btn btn-success">修改微博认证</a></div></div>
               <div class="container page_bg">微信号 ：18210354073 &nbsp; <div class="btn-group"><a href="" class="btn btn-success">修改微信认证</a></div></div>      

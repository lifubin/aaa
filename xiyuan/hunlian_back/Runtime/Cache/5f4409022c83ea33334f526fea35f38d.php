...
<div class="container-fluid">
	<div class="widget-box">
          ...
          <div class="widget-content nopadding">
            <form class="form-horizontal" method="post" action="__URL__/update" name="node_form" id="node_form" novalidate="novalidate">
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="title" id="title" value="<?php echo ($vo["title"]); ?>" maxlength="32" >
                </div>
              </div>
              ...
              <div class="control-group">
	              ...
	              <div class="controls">
	                <select name="pid" id="pid" style="width:30%;">
	                	...
	                	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><option <?php if($vo["pid"]==$item['id']){echo "selected=true";} ?> value="<?php echo ($item['id']); ?>"><?php echo str_repeat("&nbsp;&nbsp;&nbsp;",$item['level']); echo ($item["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
	                </select>
	              </div>
              </div>
             ...
             <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" name="sort" id="sort" value="<?php echo ($vo["sort"]); ?>"  />
                </div>
              </div>

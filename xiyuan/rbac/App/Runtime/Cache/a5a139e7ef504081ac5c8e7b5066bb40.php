...
<div class="content">
<div class="title"> <?php if(($level) == "1"): ?>项目<?php endif; if(($level) == "2"): ?>模块<?php endif; if(($level) == "3"): ?>操作<?php endif; ?>排序  [ <a href="__URL__">返回列表</a> ]</div>
<script language="JavaScript">
<!--
function saveSort(){
sl.ok();
ThinkAjax.sendForm('form1','__URL__/saveSort/','result');
}
//-->
</script>
<div id="result" class="result none"></div>
<script type="text/javascript" src="/ThinkPHP3.1.3_full/rbac/Public/Js/Form/SortSelect.js"></script>
...
<?php if(is_array($sortList)): $i = 0; $__LIST__ = $sortList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$node): $mod = ($i % 2 );++$i;?><option value="<?php echo ($node["id"]); ?>"><?php echo ($i); ?>.<?php echo ($node["title"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
</SELECT></div></td>
...
<tr>
	...
	<div style="width:85%"><input type="hidden" name="seqNoList">
